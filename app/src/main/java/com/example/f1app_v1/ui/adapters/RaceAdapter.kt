...
class RaceAdapter(
    private val RaceList: RaceBaseInfo,
    private val itemClickListener: OnRaceClickListener
) : RecyclerView.Adapter<BaseViewHolder<*>>() {

    interface OnRaceClickListener {
        fun onRaceClick(race: RaceBaseInfo.Stage.Race)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*> {
        ...
        itemBinding.root.setOnClickListener {
            ...
            itemClickListener.onRaceClick(RaceList.stage.stages[position])
        }
